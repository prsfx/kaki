...
To avoid this, you can avoid this with using simple folder structure.
...
|   |__screen
|   |   |
|   |   |__ *your screens/widgets should be here.
|   |
|   |__assets
|   |   |
|   |   |__ *your assets should be place here.
|   |
|   |__screens_manager.kv & screens_manager.py
|   |
|   |__some py for settings, custom configs and etc.
|
|__main.py
|
|__buildozer.spec
...
source.include_patterns = components/*
...
requirements = python3,kivy,kaki,kivymd
...
# presplash.filename = %(source.dir)s/components/static/icon/main-icon.png

# (str) Icon of the application
#icon.filename = %(source.dir)s/data/icon.png
# icon.filename = %(source.dir)s/components/static/icon/main-icon.png
...
** this is most common buildozer.spec settings.

Built tested on:

- Windows 10 Home environment with WSL2 Ubuntu at store.

- <a href="https://github.com/ntaraujo/kivy-easier">kivy-easier</a>
